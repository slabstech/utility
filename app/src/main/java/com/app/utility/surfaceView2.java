...
public class surfaceView2 extends Activity implements OnTouchListener{
   ...
   int r=0,b=0,g=0;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ball=BitmapFactory.decodeResource(getResources(), R.drawable.snake);
        blob=BitmapFactory.decodeResource(getResources(), R.drawable.icon);
